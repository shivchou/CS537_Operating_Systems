...
struct proc {
  ...
  int expectedComplete;       //expected completion time
  uint globalTick;            //track start time using global ticks
  int skip;                   //mark if this process should be skipped this sched. round
};
typedef struct {
